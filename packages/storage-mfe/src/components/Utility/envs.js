...
export const Envs = {
  ...
  MINIO_EXTERNAL_ENDPOINT: getInjectedEnv('MINIO_EXTERNAL_ENDPOINT') || process.env.MINIO_EXTERNAL_ENDPOINT,
  MINIO_CA_CERT_PATH: getInjectedEnv('MINIO_CA_CERT_PATH') || process.env.MINIO_CA_CERT_PATH,
};
