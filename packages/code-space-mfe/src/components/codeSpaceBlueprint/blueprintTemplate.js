  ...
  const template = `
    <mxGraphModel dx="1428" dy="751" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageScale="1" pageWidth="1700" pageHeight="1100" math="0" shadow="0">
      <root>
        ...
        <mxCell id="ujUrj7wP6LcdkLsmr5C5-14" value="Staging - ${intDeploymentDetails?.lastDeploymentStatus === 'DEPLOYED' ? 'Deployed' : 'No Deployment'}" style="text;html=1;align=left;verticalAlign=middle;whiteSpace=wrap;rounded=0;fontStyle=0;fontSize=12;fontFamily=Verdana;" parent="1" vertex="1">
        ...
        <mxCell id="yNrRxmF-IllQESKTyaMv-7" value="Production - ${prodDeploymentDetails?.lastDeploymentStatus === 'DEPLOYED' ? 'Deployed' : 'No Deployment'}" style="text;html=1;align=left;verticalAlign=middle;whiteSpace=wrap;rounded=0;fontStyle=0;fontSize=12;fontFamily=Verdana;" vertex="1" parent="1">
