...
//						run.setExogenData(false);
					if(runId!=null && (run.getIsDelete() == null || !run.getIsDelete()) &&
						...
						if (runId != null && (run.getIsDelete() == null || !run.getIsDelete()) && (state != null &&
								...
								"INTERNAL_ERROR".equalsIgnoreCase(state.getLife_cycle_state()) ||
								"SKIPPED".equalsIgnoreCase(state.getLife_cycle_state()))) &&
								!"SUCCESS".equalsIgnoreCase(state.getResult_state()) && !"INFO".equalsIgnoreCase(state.getResult_state()) && !"CANCELED".equalsIgnoreCase(state.getResult_state()) && (run.getError() == null || "".equalsIgnoreCase(run.getError())
							...
							//check if exogenous data is present
							if(("SUCCESS".equalsIgnoreCase(state.getResult_state()) || "INFO".equalsIgnoreCase(state.getResult_state())) && run.getExogenData()==null) {
