...
export default class Entitlement extends React.Component<IEntitlementProps, IEntitlementState> {
    ...
    protected handleDeleteEntitlement = () => {
        const updatedList = this.state.entitelmentList.filter((item: any) => item.entitlementName !== this.state.deleteEntitlementName);
        this.setState({
    ...
    protected onPaginationPreviousClick = () => {
        ...
        const modifiedData = this.state.entitelmentListResponse.slice(currentPageOffset, this.state.maxItemsPerPage * currentPageNumberTemp);
        this.setState({
            entitelmentList: modifiedData,
    ...
    protected updateEntitlement = (entitlementData: any) => {
        ...
        if (entitlementExists) {
            ...
            const updatedEntitelmentListListResponse = [...this.state.entitelmentListResponse, {
                ...entitlementData,
            }];
                        ...
                        <div className={classNames('decriptionSection', 'mbc-scroll')}>
                            ...
                            <div className={Styles.parentEntitlement}>
                                <div className={Styles.checkboxWrapper}>
                                    <label className={classNames('checkbox', !CODE_SPACE_DISABLE_DNA_PROTECT.includes(this.state.config?.status) ? '' : 'hide')}>
                                ...
                                <div className={classNames(Styles.createEntitlementButton)}>
                                    <button className={classNames('btn add-dataiku-container btn-primary',
                                        ...
                                        title={!CODE_SPACE_STATUS.includes(this.state.config?.status) ? 'Once the config is in published state, can add New Entitlement.' : ''}
                        ...
                        <ConfirmModal
                            ...
                            content={
                                <div className={Styles.deleteForecastResult}>
                                    ...
                                    <div>
                                        All API Path/Pattern and HTTP Method will be removed from the entitlement.<br />
                        ...
                        <ConfirmModal
                            ...
                            content={
                                <div className={Styles.deleteForecastResult}>
                                    ...
                                    <div>
                                        You are going to delete the Entitlement which will be removed from roles and role-mappings as well.<br />
                                        Are you sure you want to proceed?
                                    </div>
                                    < br />
