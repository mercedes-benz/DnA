...
public interface AuthenticatorClient {
	...
	public GenericMessage deleteService(String serviceName, String cloudServiceProvider, String redirectUri, String ignorePaths, String scope, String oneApiVersionShortName, boolean isSecuredWithCookie, boolean secureWithIAM);
