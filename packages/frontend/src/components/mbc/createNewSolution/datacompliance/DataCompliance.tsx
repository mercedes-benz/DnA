      ...
      <div className={Styles.processFlowWrapper}>
        <div className={Styles.step1Container}>
          ...
          <p>
            You start with the{' '}
            <a
              href="https://legalbot.app.corpintra.net/?bot=6454c7f4e348b8f6af9247be95cbf70271a7727f4c56a116c679d8f99ad7f0a7"
              target="_blank"
              rel="noreferrer"
            >
        ...
        <div className={Styles.step4Container}>
          ...
          <p>
            ...
            <a href="https://social.intra.corpintra.net/docs/DOC-188868" target="_blank" rel="noreferrer">
      ...
      <React.Fragment>
        ...
        {this.state.showInfoModal && (
          <InfoModal
            ...
            moreInfoLink="https://social.intra.corpintra.net/docs/DOC-170669"
