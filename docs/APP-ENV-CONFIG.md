...
| PROJECTSMO_INTERNAL_USER_TEAMS_INFO<br/>`string`            | `(Recommended to use Short ID. To find Short ID use <a href="https://your-teams-url.com/" target="_blank" rel="noreferrer noopener">Teams</a>)` | NA            | Content that comes on user search label                                                                                                                                                            |
