package com.daimler.data.notifications.common.producer;
...
public class KafkaProducerService {
	...
	public void send(String eventType, String resourceId, String messageDetails, String publishingUser, String message,
			Boolean mail_required, List<String> subscribedUsers, List<String> subscribedUsersEmail,
	...
	private GenericEventRecord defaultRecordBuilder(String eventType, String resourceId, String messageDetails,
			...
			List<String> subscribedUsersEmail, List<ChangeLogVO> changeLogs) {
		...
		log.info(
				"New event record created for resource {} with detail eventtype : {} "
						+ "publishingUser: {} and subscribers: {}",
				resourceId, eventType, publishingUser, subscribedUsers);
		return eventRecord;
	}
