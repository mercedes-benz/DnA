...
export const Envs = {
  ...
  DATAPRODUCT_API_BASEURL: getDNAInjectedEnv('DATA_PRODUCT_API_BASEURL') || process.env.DATA_PRODUCT_API_BASEURL,
  ENABLE_PROVISION_AND_UPLOAD: getInjectedEnv('ENABLE_PROVISION_AND_UPLOAD') || process.env.ENABLE_PROVISION_AND_UPLOAD
};
