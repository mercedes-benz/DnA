...
export const serializeReportRequestBody = (requestBody: ICreateNewReportRequest) => {
  ...
  requestBody.data.description.frontendTechnologies = requestBody.data.description.frontendTechnologies?.length == 1 && requestBody.data.description.frontendTechnologies[0].name == 'Choose'?
  null:
  ...
  requestBody.data.description.designGuideImplemented = requestBody.data.description.designGuideImplemented?.length == 1 && requestBody.data.description.designGuideImplemented.includes('Choose')? 
  null:
  requestBody.data.description.designGuideImplemented
    ...
    ?.toString() as any;
  requestBody.data.description.productPhase = requestBody.data.description.productPhase?.length == 1 && requestBody.data.description.productPhase.includes('Choose')?
  null:
