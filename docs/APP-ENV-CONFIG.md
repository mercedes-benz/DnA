...
| *VAULT_TOKEN`string`                       | `00000000-0000-0000-0000-000000000000`                     |                     | Admin token to connect with Hashicorp. vault                                                           |
...
| *VAULT_TOKEN`string`                | 00000000-0000-0000-0000-000000000000 | NA              | Admin token to connect with Hashicorp vault.           |
