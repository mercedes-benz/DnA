...
export const Envs = {
  ...
  POWER_PLATFORM_FULL_DEVELOPMENT_ACCOUNT_URL: getInjectedEnv('POWER_PLATFORM_FULL_DEVELOPMENT_ACCOUNT_URL') || process.env.POWER_PLATFORM_FULL_DEVELOPMENT_ACCOUNT_URL,
