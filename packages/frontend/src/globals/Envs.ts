...
export const Envs = {
  ...
  DATAIKU_LIVE_APP_URL:
    getInjectedEnv('DATAIKU_LIVE_APP_URL') || process.env.DATAIKU_LIVE_APP_URL || 'https://dss-dev.xto.corpintra.net',
  DATAIKU_TRAINING_APP_URL:
    getInjectedEnv('DATAIKU_TRAINING_APP_URL') ||
    process.env.DATAIKU_TRAINING_APP_URL ||
    'https://dss-training.xto.corpintra.net',
  DNA_SWAGGER_UI_URL:
    getInjectedEnv('DNA_SWAGGER_UI_URL') ||
    process.env.DNA_SWAGGER_UI_URL ||
    'https://dna-dev.app.corpintra.net/avscan/swagger-ui.html#/',
  DATAIKU_FERRET_URL:
    getInjectedEnv('DATAIKU_FERRET_URL') ||
    process.env.DATAIKU_FERRET_URL ||
    'https://ferret.daimler.com/ferret/request/createRequestMainPage.jsf?tidyup=1',
  DNA_APPNAME_HEADER: getInjectedEnv('DNA_APPNAME_HEADER') || process.env.DNA_APPNAME_HEADER || 'DnA@MBC App',
  DNA_APPNAME_HOME: getInjectedEnv('DNA_APPNAME_HOME') || process.env.DNA_APPNAME_HOME || 'Data and Analytics @MBC',
  DNA_CONTACTUS_HTML:
    ...
    <div>
      ...
      <p>
        Mattermost:&nbsp;
        <a href="https://matter.i.daimler.com/daimler-ag/channels/dna-platform" target="_blank" rel="noreferrer">
          https://matter.i.daimler.com/daimler-ag/channels/dna-platform
        </a>
      </p>
      <p>
        Email:&nbsp;<a href="mailto:dna@daimler.com">dna@daimler.com</a>
      </p>
    </div>
  `,
  DNA_BRAND_LOGO_URL:
  ...
  DNA_COMPANYNAME: getInjectedEnv('DNA_COMPANYNAME') || process.env.DNA_COMPANYNAME || 'Daimler',
};
