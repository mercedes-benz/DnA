window['INJECTED_ENVIRONMENT'] = {
  ...
  DNA_ENVIRONMENT: 'YOUR_DNA_ENVIRONMENT',
...
ENABLE_UILICIOUS_SERVICE: true,
  ...
  MB_AI_ECOSYSTEM_URL: 'YOUR_MB_AI_ECOSYSTEM_URL',
  MB_AI_USE_CASE_URL: 'YOUR_MB_AI_USE_CASE_URL',
  ...
  UILICIOUS_URL: 'YOUR_UILICIOUS_URL',
  UILICIOUS_CONTACT: 'YOUR_UILICIOUS_CONTACT',
...
window["FABRIC_INJECTED_ENVIRONMENT"]={
  ...
  MANDATE_LEANIX_FOR_DIVISIONS : 'YOUR_MANDATE_LEANIX_FOR_DIVISIONS',
  MB_INSIDE_URL: 'YOUR_MB_INSIDE_URL',
  CDC_URL: 'YOUR_CDC_URL',
  DNA_MAIL: 'YOUR_DNA_MAIL',
  CONFLUENCE_PAGE: 'YOUR_CONFLUENCE_PAGE',
  CDC_SIGNIN_URL: 'YOUR_CDC_SIGNIN_URL',
  FABRIC_REPORT_URL: 'YOUR_FABRIC_REPORT_URL',
  FABRIC_ACTIVITY_REPORT_URL: 'YOUR_FABRIC_ACTIVITY_REPORT_URL',
  INFORMATION_OWNER_URL: 'YOUR_INFORMATION_OWNER_URL',
  DATA_AT_CLOUD_URL: 'YOUR_DATA_AT_CLOUD_URL',
  DDX_PRICING_URL: 'YOUR_DDX_PRICING_URL',
  DDX_DOF_BASE_URL: 'YOUR_DDX_DOF_BASE_URL',
  TICKET_SUPPORT_URL: 'YOUR_TICKET_SUPPORT_URL',
  SECURITY_LEVELS: 'YOUR_SECURITY_LEVELS',
  DDX_DP_APPROVAL_MAIL: 'YOUR_DDX_DP_APPROVAL_MAIL',
};
...
window['CODE_SPACE_INJECTED_ENVIRONMENT'] = {
  ...
  CODE_SPACE_GIT_PAT_APP_URL: 'YOUR_PRIVATE_GITHUB_URL',
  CODE_SPACE_GIT_ORG_NAME: 'YOUR_CODESPACE_GIT_ORG_NAME',
  CODE_SPACE_GHE_ORG_NAME: 'YOUR_CODESPACE_GHE_ORG_NAME',
  CODE_SPACE_GHE_PAT_APP_URL: 'YOUR_CODE_SPACE_GHE_PAT_APP_URL',
  CODE_SPACE_GHE_PAT_SETTINGS_URL: 'YOUR_CODE_SPACE_GHE_PAT_SETTINGS_URL',
  CODE_SPACE_GHES_ORG_URL: 'YOUR_CODESPACE_GHES_ORG_URL',
  CODE_SPACE_GHEC_ORG_URL: 'YOUR_CODESPACE_GHEC_ORG_URL',
  CODESPACE_OPENSEARCH_LOGS_URL: 'YOUR_CODESPACE_LOGS_VIEW_URL?query=$INSTANCE_ID$',
  CODESPACE_OPENSEARCH_BUILD_LOGS_URL: 'YOUR_CODESPACE_BUILD_LOGS_VIEW_URL?query=$INSTANCE_ID$',
  CODESPACE_GHE_BUILD_DEPLOY_WORKFLOW_URL: 'YOUR_CODESPACE_GHE_BUILD_DEPLOY_WORKFLOW_URL',
  CODESPACE_OIDC_POPUP_URL: 'YOUR_CODESPACE_OIDC_LOGIN_URL',
  ...
  CODESPACE_INT_MIGRATION_CUTOFF: 'YOUR_CODESPACE_INT_MIGRATION_CUTOFF',
  ...
  DNA_CLIENT_ID: 'YOUR_DNA_CLIENT_ID',
  DNA_SSO_TYPE: 'YOUR_DNA_SSO_TYPE',
  DNA_APP_ID: 'YOUR_DNA_APP_ID',
  DNA_ENTITLEMENT_PREFIX: 'YOUR_DNA_ENTITLEMENT_PREFIX',
  FABRIC_API_BASEURL: 'YOUR_FABRIC_API_BASEURL',
};
