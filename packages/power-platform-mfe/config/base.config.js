...
module.exports = {
  ...
  plugins: [
    ...
    new ModuleFederationPlugin({
      name: 'power_platform_mfe',
      filename: 'remoteEntry.js',
      exposes: {
        './PowerPlatform': './src/App',
      },
      remotes: {
        'dna-container': `dna_container@[(window.POWER_PLATFORM_INJECTED_ENVIRONMENT && window.POWER_PLATFORM_INJECTED_ENVIRONMENT.CONTAINER_APP_URL)]/remoteEntry.js?[(new Date()).getTime()]`,
      },
      shared: {
        ...deps,
