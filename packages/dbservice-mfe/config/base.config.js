...
module.exports = {
  ...
  plugins: [
    ...
    new ModuleFederationPlugin({
      ...
      remotes: {
        'dna-container': `dna_container@[(window.DB_SERVICE_INJECTED_ENVIRONMENT && window.DB_SERVICE_INJECTED_ENVIRONMENT.CONTAINER_APP_URL)]/remoteEntry.js?[(new Date()).getTime()]`,
      },
      shared: {
        ...deps,
