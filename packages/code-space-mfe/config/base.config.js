...
module.exports = {
  ...
  plugins: [
    ...
    new ModuleFederationPlugin({
      ...
      remotes: {
        'dna-container': `dna_container@[(window.CODE_SPACE_INJECTED_ENVIRONMENT && window.CODE_SPACE_INJECTED_ENVIRONMENT.CONTAINER_APP_URL)]/remoteEntry.js?[(new Date()).getTime()]`,
      },
      shared: {
        ...deps,
