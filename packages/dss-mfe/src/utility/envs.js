...
export const Envs = {
  ...
  DATAIKU_TOU_URL: getInjectedEnv('DATAIKU_TOU_URL') || process.env.DATAIKU_TOU_URL,
  ...
  DATAIKU_LICENSE_CREATION_CONTENT: getDNAInjectedEnv('DATAIKU_LICENSE_CREATION_CONTENT') || process.env.DATAIKU_LICENSE_CREATION_CONTENT,
};
