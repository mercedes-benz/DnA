window['INJECTED_ENVIRONMENT'] = {
  ...
  UDEMY_URL: 'http://localhost:7979/api',
  ...
  TERMS_OF_USE_CONTENT: '<iframe src="/DnA-Platform-General-TermsOfUse-V1.0.pdf" style="width:100%;height:50vh;border:none;margin:0;padding:0;"></iframe>',
...
window['DATA_PRODUCT_INJECTED_ENVIRONMENT'] = {
  ...
  DATA_GOVERNANCE_HTML_FOR_CHINA_DATA:
    '<p>Due to new chinese data protection regulations, we recommend to clarify, if you are allowed to further share this chinese data. For further information please reach out to <a href="mailto:cross-border_data_transfer_project@mercedes-benz.com" target="_blank" rel="noopener noreferrer">cross-border_data_transfer_project@mercedes-benz.com</p>',
