    ...
    <React.Fragment>
      ...
      >
        ...
        <td>
          ...
          {item.state.result_state !== 'WARNINGS' && item.warningsInfo !== null && item.warningsInfo.length > 0 && <i className={classNames('icon mbc-icon info circle', Styles.infoCircle)}  onClick={(e) => handleStatusClick(e, item)} tooltip-data={'Click to View the Warning Info'} />}
