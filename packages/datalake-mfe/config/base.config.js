...
module.exports = {
  ...
  plugins: [
    ...
    new ModuleFederationPlugin({
      ...
      remotes: {
        'dna-container': `dna_container@[(window.DATALAKE_INJECTED_ENVIRONMENT && window.DATALAKE_INJECTED_ENVIRONMENT.CONTAINER_APP_URL)]/remoteEntry.js?[(new Date()).getTime()]`,
      },
      shared: {
        ...deps,
