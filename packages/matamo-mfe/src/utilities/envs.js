...
const getInjectedEnv = (key) => {
  if (window.MATAMO_INJECTED_ENVIRONMENT) {
    return window.MATAMO_INJECTED_ENVIRONMENT[key];
  }
  return undefined;
};
...
export const Envs = {
  MATAMO_API_BASEURL: getInjectedEnv('MATAMO_API_BASEURL') || process.env.MATAMO_API_BASEURL,
