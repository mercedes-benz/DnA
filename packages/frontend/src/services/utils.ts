...
export const recipesMaster = [
  ...
  { id: 'dash-python', resource: '2Gi,1000Mi,500m,2000Mi,1000m', name: 'Dash Python (Debian 11 OS, 2GB RAM, 1CPU)' },
  { id: 'streamlit-python', resource: '2Gi,1000Mi,500m,2000Mi,1000m', name: 'Streamlit Python (Debian 11 OS, 2GB RAM, 1CPU)' },
  { id: 'express-node', resource: '2Gi,1000Mi,500m,2000Mi,1000m', name: 'Microservice using Express - Node.js (Debian 11 OS, 2GB RAM, 1CPU)' },
  { id: 'nestjs-node', resource: '2Gi,1000Mi,500m,2000Mi,1000m', name: 'Microservice using NestJS - Node.js (Debian 11 OS, 2GB RAM, 1CPU)' },
