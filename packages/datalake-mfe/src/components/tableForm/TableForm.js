  ...
  return (
    <div className={Styles.columnsWrapper}>
      <div className={Styles.columnContainer}>
                  ...
                  <input
                    ...
                    {...register(`${index}.notNullConstraintEnabled`, {
                      onChange: (e) => {
                        ...
                        props.setColumnValues(
                          props.index,
                          val,
                          "notNullConstraintEnabled"
                        );
                      },
                    })}
                    defaultChecked={true}
        ...
        <div className={Styles.flexLayout}>
          <button
            className={classNames("btn btn-primary", Styles.btnActions)}
          ...
          <div>
            ...
            <span className={classNames("error-message")}>
              ...
              {errors.tableName?.type === "pattern" &&
                "Table names can only consist of lowercase letters, numbers, and underscores ( _ ) and cannot start with numbers."}
            </span>
          </div>
        </div>
        <div className={Styles.configurationContainer}>
