...
```
update the images names in the [values.yaml](../deployment/kubernetes/helm/values.yaml) . You can refer the values.yaml to check on where to update the images
