...
export const Envs = {
  ...
  POWER_PLATFORM_DEFAULT_ENVIRONMENT_URL: getDNAInjectedEnv('POWER_PLATFORM_DEFAULT_ENVIRONMENT_URL') || process.env.POWER_PLATFORM_DEFAULT_ENVIRONMENT_URL,
  POWER_PLATFORM_CITIZEN_DEVELOPER_ACCOUNT_URL: getDNAInjectedEnv('POWER_PLATFORM_CITIZEN_DEVELOPER_ACCOUNT_URL') || process.env.POWER_PLATFORM_CITIZEN_DEVELOPER_ACCOUNT_URL,
  POWER_PLATFORM_FULL_DEVELOPER_ACCOUNT_URL: getDNAInjectedEnv('POWER_PLATFORM_FULL_DEVELOPER_ACCOUNT_URL') || process.env.POWER_PLATFORM_FULL_DEVELOPER_ACCOUNT_URL,
  POWER_PLATFORM_SUPPORT_EMAIL: getDNAInjectedEnv('POWER_PLATFORM_SUPPORT_EMAIL') || process.env.POWER_PLATFORM_SUPPORT_EMAIL,
  POWER_PLATFORM_SOCIAL_INTRANET_URL: getDNAInjectedEnv('POWER_PLATFORM_SOCIAL_INTRANET_URL') || process.env.POWER_PLATFORM_SOCIAL_INTRANET_URL,
};
